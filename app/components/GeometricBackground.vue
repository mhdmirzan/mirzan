...
const cachedColors = computed(() => {
  ...
  if (isDark) {
    return {
      primary: { r: 109, g: 150, b: 247 },
      secondary: { r: 156, g: 188, b: 255 },
      accent: { r: 220, g: 231, b: 255 },
      tertiary: { r: 196, g: 215, b: 255 },
      lineOpacity: 0.4,
      particleOpacity: 0.8,
    }
  } else {
    return {
      primary: { r: 10, g: 42, b: 94 },
      secondary: { r: 8, g: 34, b: 77 },
      accent: { r: 6, g: 26, b: 59 },
      tertiary: { r: 4, g: 19, b: 43 },
      lineOpacity: 0.4,
      particleOpacity: 0.6,
    }
  }
