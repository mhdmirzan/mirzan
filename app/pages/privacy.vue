...
// SEO Meta
useHead({
  title: "Privacy Policy - Mohammed Mirzan",
  meta: [
    {
      name: "description",
      content:
        "Privacy policy for mirzan.js.org - Learn how I collect, use, and protect your personal information on my website.",
    },
    {
      property: "og:title",
      content: "Privacy Policy - Mohammed Mirzan",
    },
    {
        ...
        <UCard variant="soft">
          <div class="space-y-4">
            ...
            <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
              Welcome to mirzan.js.org ("I," "my," or "me"). This privacy
              policy explains how Mohammed Mirzan collects, uses, and
        ...
        <UCard variant="soft">
          <div class="space-y-4">
            ...
            <UAlert
              ...
              description="To exercise any of these rights, please contact me at hello@mirzan.js.org. I will respond within 30 days."
            />
          </div>
        </UCard>
        ...
        <UCard variant="soft">
          <div class="space-y-4">
            ...
            <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              provided me with personal information, please contact me
              immediately so I can delete such information.
            </p>
          </div>
        </UCard>
