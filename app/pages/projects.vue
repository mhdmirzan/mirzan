    ...
    <div class="space-y-24">
      ...
      <div class="text-center">
        ...
        <p class="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
          A showcase of AI-powered solutions, data engineering pipelines, data analytics projects, 
          and open-source contributions I've built to drive insights and innovation.
        </p>
      </div>
      ...
      <section class="space-y-8">
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <!-- Project Image -->
            <div
              class="aspect-video bg-gray-100 dark:bg-gray-800 mb-4 flex items-center justify-center overflow-hidden rounded-lg relative"
            >
              <UCarousel
            ...
            <div class="space-y-3">
              <div>
                ...
                <p
                  class="text-gray-600 dark:text-gray-400 text-sm line-clamp-8"
                >
                  {{ project.description }}
                </p>
              </div>
