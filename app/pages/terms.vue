...
// SEO Meta
useHead({
  title: "Terms of Service - Mohammed Mirzan",
  meta: [
    {
      name: "description",
      content:
        "Terms of service for mirzan.js.org - Learn about my service terms, client agreements, and professional guidelines for working together.",
    },
    {
      property: "og:title",
      content: "Terms of Service - Mohammed Mirzan",
    },
    {
...
// Last updated date
const lastUpdated = ref("July 1, 2025")
</script>
  ...
  <div>
    ...
    <div class="max-w-4xl mx-auto space-y-8">
      ...
      <div class="space-y-8">
        ...
        <UCard variant="soft">
          <div class="space-y-4">
            ...
            <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
              Welcome to mirzan.js.org. These Terms of Service ("Terms") govern
              your use of my website and any professional services provided by
              Mohammed Mirzan ("I," "my," or "me"). By accessing my website
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li class="flex items-start gap-2">
                  <UIcon
                    ...
                    class="w-4 h-4 text-primary mt-1 flex-shrink-0"
                  />
                  <span>Subscribe to my newsletter and updates</span>
                </li>
              </ul>
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li class="flex items-start gap-2">
                  ...
                  <span
                    ...
                    be conducted via email and scheduled meetings</span
                  >
                </li>
              </ul>
            </div>
            ...
            <div class="space-y-4">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start gap-2">
                  <UIcon
                    name="i-ph-users"
                    class="w-4 h-4 text-primary-600 mt-1 flex-shrink-0"
                  />
                  <span
        ...
        <UCard variant="soft">
          <div class="space-y-4">
              ...
              <div class="space-y-3">
                ...
                <ul class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                  <li class="flex items-center gap-2">
                    ...
                    <span>25% deposit required before project start</span>
                  </li>
                  <li class="flex items-center gap-2">
                    <UIcon name="i-ph-circle" class="w-2 h-2 text-primary" />
            ...
            <UAlert
              ...
              description="All project work is suspended if payments become overdue. Additional fees may apply for project resumption."
            />
          </div>
        </UCard>
                ...
                <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                  ...
                  <li class="flex items-start gap-2">
                    ...
                    <span
                      ...
                      negotiation preferred, mediation if needed</span
                    >
                  </li>
                  <li class="flex items-start gap-2">
                    <UIcon
        ...
        <!-- Call to Action -->
        <div
          class="text-center py-8 bg-gradient-to-r from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-900/20"
        >
